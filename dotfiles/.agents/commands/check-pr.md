...
- Measure the real merit of each code comment and don't let yourself be swayed by the tone of the author;
- Comment should either spot severe issues, measurable performance or maintainability improvements;
